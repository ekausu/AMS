<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="AdvanceSystem.Login" %>
...
<div class="form">
  ...
  <div class="topbar">
    <div class="spanColor"></div>
	  <h1 style="text-align:center;color:yellow;">AMS SYSTEM</h1>
	   <input type="text" runat="server" class="input" id="txtUser" placeholder="User Name"/>
    <input type="password" runat="server" class="input" id="password" placeholder="Password"/>
  </div>
  <button class="submit" runat="server" onserverclick="submit_ServerClick" id="submit" >Login</button>
</div>
