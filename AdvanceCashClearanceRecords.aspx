<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdvanceCashClearanceRecords.aspx.cs" Inherits="AdvanceSystem.AdvanceCashClearanceRecords" %>
               ...
               <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well">
						<h2><i class="icon-file"></i>PAYMENT RECEIPT RECORDS</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<div style="width:100%">
<img src="images/pie-chart_256x256.png" width="100" height="100" />
<h2 style="margin-left:30%">PAYMENT RECEIPT RECORDS"></h2></div>
                           <asp:GridView ID="GridviewCashReceipts" PageSize="50" AllowPaging="true" OnPageIndexChanging="GridviewCashReceipts_PageIndexChanging" ShowHeaderWhenEmpty="true" EmptyDataText="" AutoGenerateColumns="false"  CssClass="table table-striped table-bordered bootstrap-datatable datatable"  runat="server">
                               <EmptyDataTemplate>
             ...
             <div class="btn-group" style="width:90%">
							...
							<ul class="dropdown-menu">
                                <li><a id="BtnGenerate" runat="server" onserverclick="BtnGenerate_ServerClick"><i class="icon32 icon-color icon-clipboard"></i>Print Cash Receipt</a></li>
							 </ul>
						</div>
                </ItemTemplate>
             </asp:TemplateField>
