$(document).ready(function(){
    ...
    $('#themes a').click(function (e) {
        ...
        SetCookie('current_theme', current_theme, { expires: 365 });
        switch_theme(current_theme);
        $('#themes i').removeClass('icon-ok');
        $(this).find('i').addClass('icon-ok');
    });
...
function docReady(){
	...
	if($('.tour').length && typeof(tour)=='undefined')
	{
		...
		tour.addStep({
			...
			placement: "top",
			title: "System Forms", /* title of the popover */
			content: "Forms have controls on their right. Use the close button to close and minimise icon to minimise forms." /* content of the popover */
		});
		tour.addStep({
		...
		tour.addStep({
			...
			title: "Menu",
			content: "Click any menu item to access another page."
		});
		tour.addStep({
            element: "#breadcrumb",
			title: "Bread Crumb",
			content: "Use this for quick access."
		});
		tour.addStep({
			element: ".top-nav a:first",
			placement: "bottom",
			title: "Logo",
			content: "Click to access home page."
		});
